...
- [ugf-editortools](https://github.com/unity-game-framework/ugf-editortools) `3.0.0-preview.13`   
...
- [ugf-module-assetbundles](https://github.com/unity-game-framework/ugf-module-assetbundles) `3.0.0-preview.4`   
  Module to manage AssetBundles loading.
- [ugf-module-assets](https://github.com/unity-game-framework/ugf-module-assets) `6.0.0-preview.2`   
...
- [ugf-module-purchasing](https://github.com/unity-game-framework/ugf-module-purchasing) `2.0.0-preview.3`   
  Module to manage Unity Purchasing.
- [ugf-module-scenes](https://github.com/unity-game-framework/ugf-module-scenes) `5.0.0-preview`   
  Module to manage scenes loading.
- [ugf-module-serialize](https://github.com/unity-game-framework/ugf-module-serialize) `6.0.0-preview`   
  Module to manage multiple serializers in an application.
- [ugf-module-services](https://github.com/unity-game-framework/ugf-module-services) `1.0.0-preview.3`   
  Module to manage Unity Game Services.
- [ugf-module-update](https://github.com/unity-game-framework/ugf-module-update) `5.0.0-preview`   
...
- [ugf-application](https://github.com/unity-game-framework/ugf-application) `9.0.0-preview`   
...
- [ugf-assets](https://github.com/unity-game-framework/ugf-assets) `1.0.0-preview.2`   
  Provides utilities to work with assets.
- [ugf-build](https://github.com/unity-game-framework/ugf-build) `1.3.0`   
...
- [ugf-coroutines](https://github.com/unity-game-framework/ugf-coroutines) `1.1.0`   
...
- [ugf-customsettings](https://github.com/unity-game-framework/ugf-customsettings) `3.4.1`   
  Provides utilities to implement custom ProjectSettings or Preferences, for editor or runtime.
- [ugf-debugtools](https://github.com/unity-game-framework/ugf-debugtools) `3.0.0-preview.1`   
...
- [ugf-jsonnet-bson](https://github.com/unity-game-framework/ugf-jsonnet-bson) `1.0.0`   
...
- [ugf-runtimetools](https://github.com/unity-game-framework/ugf-runtimetools) `3.0.0-preview.18`   
...
- [ugf-serialize-jsonnet](https://github.com/unity-game-framework/ugf-serialize-jsonnet) `3.0.0`   
  Serializers implementation using Json.Net serialization.
- [ugf-serialize-jsonnet-bson](https://github.com/unity-game-framework/ugf-serialize-jsonnet-bson) `1.0.0`   
...
- [ugf-state](https://github.com/unity-game-framework/ugf-state) `1.0.0-preview.1`   
  Provides components to apply object state.
- [ugf-tables](https://github.com/unity-game-framework/ugf-tables) `1.0.0-preview.1`   
  Provides tools to work with data represented as table.
- [ugf-ui](https://github.com/unity-game-framework/ugf-ui) `2.0.0`   
...
- [ugf-actions](https://github.com/unity-game-framework/ugf-actions) `3.0.0-preview.4` `Archived`  
...
- [ugf-core](https://github.com/unity-game-framework/ugf-core) `Archived`  
  UGF.Core
- [ugf-data](https://github.com/unity-game-framework/ugf-data) `3.0.0` `Archived`  
...
- [ugf-elements](https://github.com/unity-game-framework/ugf-elements) `0.2.2-preview` `Archived`  
  UGF.Elements
- [ugf-events](https://github.com/unity-game-framework/ugf-events) `2.0.0-preview.1` `Archived`  
...
- [ugf-messagepack](https://github.com/unity-game-framework/ugf-messagepack) `Archived`  
  UGF.MessagePack
- [ugf-messages](https://github.com/unity-game-framework/ugf-messages) `1.0.0-preview.2` `Archived`  
  Provides components with Unity standard messages.
- [ugf-models](https://github.com/unity-game-framework/ugf-models) `3.0.0-preview.4` `Archived`  
...
- [ugf-module](https://github.com/unity-game-framework/ugf-module) `0.2.0-preview` `Archived`  
  UGF.Module
- [ugf-module-actions](https://github.com/unity-game-framework/ugf-module-actions) `2.0.0-preview.5` `Archived`  
...
- [ugf-module-clouddiagnostics](https://github.com/unity-game-framework/ugf-module-clouddiagnostics) `1.0.0-preview.1` `Archived`  
...
- [ugf-mvc](https://github.com/unity-game-framework/ugf-mvc) `1.1.0-preview` `Archived`  
  UGF.Mvc
- [ugf-navigation](https://github.com/unity-game-framework/ugf-navigation) `1.0.0-preview.1` `Archived`  
...
- [ugf-property](https://github.com/unity-game-framework/ugf-property) `2.0.0-preview` `Archived`  
...
- [ugf-stringcache](https://github.com/unity-game-framework/ugf-stringcache) `1.0.1` `Archived`  
  UGF.StringCache
- [ugf-testing](https://github.com/unity-game-framework/ugf-testing) `1.0.0-preview.3` `Archived`  
...
- [ugf-utf8json](https://github.com/unity-game-framework/ugf-utf8json) `4.1.1-preview` `Archived`  
  UGF.Utf8Json
- [ugf-views](https://github.com/unity-game-framework/ugf-views) `1.0.0-preview.5` `Archived`  
